...
OS: Utunbu 20.04
Application: g++ (Ubuntu 9.4.0-1ubuntu1~20.04.2) 9.4.0, yorickvis-0.1

<Requirement>
Execution of the programs requires C++ compiler.
Visualization of the simulation output requires a visualization tool "yorickvis" written in Yorick language.
...
git clone https://github.com/yorickuser/yorickvis.git -b 0.1
cd yorickvis/
./install.sh
cd ../
