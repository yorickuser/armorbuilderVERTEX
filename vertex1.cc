...
int TT  =2000000; /* total time period for simulation */
...
double upg_cool=0.2;  /* water pressure during cooling */
...
double morpha_head(double x, double y){
  ...
  value=1.2*3*0.7*expfa(x,y,0.3,0.2,0,0,0.6*dy0,0.6*dy0,sx0*0.6,0.07,sy0*0.8,0.07,20);
...
double morpha(double x, double y){
  ...
  double value=0;
    ...
    value+=3*1.5*exp(-x*x/(2*1.5*1.5)-(y+1.7)*(y+1.7)/(2*1*1));
...
void calc_met(double (*morphogen)(double,double),double d_gradx,double d_grady, double amp_tw){
  double gx,gy,gradxy[2],gradx,grady,prod,nabla,len00;
  double vlxy[3],vlxy_tw[3],bufv0[3],bufv1[3],bufv[3];
...
double morpha_deko(double x,double y){
  ...
  value+=1.4*2*expfa(x,y,0.3,0.2,1.5*dx11,1.5*dx11,dy11*0.9,dy11*0.9,1.4*sx0,0.07,1.4*sy0,0.07,20);
  value+=1.4*2*expfa(x,y,0.3,0.2,-1.5*dx11,-1.5*dx11,dy11*0.9,dy11*0.9,1.4*sx0,0.07,1.4*sy0,0.07,20);
  return value;
...
double buf;
  ...
  /* calculation of spring growth correspongind to sheet growth */
   ...
   develop(nabla2,morpha_deko,-0*d_gradx_side,3*d_grady_side,-0*amp_tw_side);//beta2
 //develop(nabla2,morpha_sideL,-0.15,0,amp_tw_side);//beta3
 //develop(nabla2,morpha_sideR,-0.15,0,-amp_tw_side);//beta4
   develop(nabla2,morpha_head,d_gradx_cen,3*d_grady_cen,amp_tw_cen);//beta5
 ...
 calc_met(morpha_deko,-0*d_gradx_side,3*d_grady_side,-0*amp_tw_side);//beta2
 //calc_met(morpha_sideL,-0.15,0,amp_tw_side);//beta3
 // calc_met(morpha_sideR,-0.15,0,-amp_tw_side);  //beta4
 calc_met(morpha_head,d_gradx_cen,3*d_grady_cen,amp_tw_cen);//beta5
