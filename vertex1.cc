...
double buf;
  ...
  /* calculation of spring growth correspongind to sheet growth */
   ...
   develop(nabla2,morpha_deko,-0*d_gradx_side,3*d_grady_side,-0*amp_tw_side);
 //develop(nabla2,morpha_sideL,-0.15,0,amp_tw_side);
 //develop(nabla2,morpha_sideR,-0.15,0,-amp_tw_side);
   develop(nabla2,morpha_head,d_gradx_cen,3*d_grady_cen,amp_tw_cen);
 ...
 calc_met(morpha_deko,-0*d_gradx_side,3*d_grady_side,-0*amp_tw_side);
 //calc_met(morpha_sideL,-0.15,0,amp_tw_side);
 // calc_met(morpha_sideR,-0.15,0,-amp_tw_side);  
 calc_met(morpha_head,d_gradx_cen,3*d_grady_cen,amp_tw_cen);
